...
estimated_savings = np.random.uniform(350_000, 1_500_000)
st.write(
    f"Potential cost savings identified (bulk purchasing, supplier consolidation, optimized reorder points): "
    f"฿{estimated_savings:,.0f}"
)

tips = [
    "Shift to monthly consolidated orders for strips and lancets to reduce logistics costs.",
    "Negotiate SLA-linked rebates with top-3 suppliers based on on-time delivery > 96%.",
    "Use demand forecast confidence to set dynamic safety stock thresholds.",
]
